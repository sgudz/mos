...
status = 1
if (float(read_16mib_median) < (float(read_16mib_median) - float(base_read_16mib_median) * 0.1)) or (float(read_16mib_stdev) < (float(read_16mib_stdev) - float(base_read_16mib_stdev) * 0.1)):
    status = 0
