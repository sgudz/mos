...
#     latency_30_ms = 0
latency_100_ms = dict(parser.items('testrail'))['latency_100_ms'] + 0
...
print latency_10_ms, latency_30_ms, latency_100_ms, base_latency_10_ms, base_latency_30_ms, base_latency_100_ms
