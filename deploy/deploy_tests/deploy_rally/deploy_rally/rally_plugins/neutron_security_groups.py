...
class NeutronSecGroupPlugin(net_utils.NeutronScenario,
    ...
    def _neutron_delete_security_groups(self, security_group):
        with atomic.ActionTimer(self, "neutron.delete_%s_security_groups" %
            ...
            for sg in security_group:
                self.clients("neutron").delete_security_group(sg['id'])
    ...
    def create_and_delete_secgroups(self, security_group_count,
        ...
        self._neutron_delete_security_groups(security_groups)
    ...
    def create_and_list_secgroups(self, security_group_count,
        ...
        self._neutron_create_rules_for_security_group(
            security_groups, rules_per_security_group)
        self._neutron_list_security_groups()
    ...
    def boot_and_delete_server_with_secgroups(self, image, flavor,
        ...
        try:
            ...
            if hasattr(e, "http_status") and e.http_status == 400:
                raise NeutronSecurityGroupException(e.message)
            raise
