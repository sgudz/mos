...
FUEL_IP="10.20.0.2"
LAST_IP=$((60+${ENV}))
FUEL_IP_FOR_ACCESS="10.30.60.${LAST_IP}"
FUEL_MASK_FOR_ACCESS="255.255.252.0"
FUEL_GW_FOR_ACCESS=""
...
OVSWITCH_PXE="br-p1p1"
OVSWITCH_PUBLIC="br-p4p1"
MASTER_NODES="172.20.9.13"
PXE_VLAN=600
PUBLIC_VLAN=602
...
setup_iso() {
    ...
    sed "0,/network='${OVSWITCH_PUBLIC}'\\/>/s//network='${OVSWITCH_PUBLIC}' portgroup='vlan-${PUBLIC_VLAN}'\\/>/" -i /tmp/${DOMAIN}.xml
